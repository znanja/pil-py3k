# setup.py adapted from the Pillow project. Might work on Linux, Mac
...
NAME = "PIL"
VERSION = '1.1.7'
DESCRIPTION = "Python 3 Imaging Library (fork)"
...
try:
    from _inclib import INCLIB, TCL_INC, TCL_LIB
    TCL_ROOT = TCL_LIB, TCL_INC
    JPEG_ROOT = INCLIB
    ZLIB_ROOT = INCLIB
    TIFF_ROOT = INCLIB
    FREETYPE_ROOT = INCLIB
    LCMS_ROOT = INCLIB
    HAVE_LIBTIFF = True
except ImportError:
    TCL_ROOT = None
...
class pil_build_ext(build_ext):
    ...
    def build_extensions(self):
        ...
        if feature.tiff and HAVE_LIBTIFF:
    ...
    def summary_report(self, feature, unsafe_zlib):
        ...
        options = [
            ...
            (feature.tiff and HAVE_LIBTIFF, "experimental TIFF G3/G4 read"),
    ...
    def add_multiarch_paths(self):
        ...
        try:
            if ret >> 8 == 0:
                fp = open(tmpfile, 'rb')
                multiarch_path_component = str(fp.readline().strip())
